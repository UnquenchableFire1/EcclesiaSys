    ...
    return (
        <div className="max-w-3xl mx-auto py-8 px-4 animate-fade-in">
            <div className="flex items-center gap-4 mb-8">
                <a href="/" className="w-10 h-10 rounded-full bg-mdSurfaceVariant/50 flex items-center justify-center text-mdPrimary hover:bg-mdPrimary hover:text-white transition-all">
